        ...
        <section className="basis-3/4">
          <div className="bg-white rounded-xl px-7 py-5 h-full">
            <div className="flex flex-col gap-5">
              <h2 className="font-bold">Change PIN</h2>
              <p className="text-gray-400 w-96">Enter your current 6 digits Fazzpay PIN below to continue to the next steps.</p>
              <div className="flex flex-col items-center justify-center mt-10">
                ...
                <button className="btn btn-accent text-white capitalize w-1/2 my-10">Continue</button>
              </div>
            </div>
          </div>
        </section>
