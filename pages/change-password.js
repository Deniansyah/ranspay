import { FiGrid, FiArrowUp, FiPlus, FiUser, FiLogOut, FiLock } from "react-icons/fi";
        ...
        <section className="basis-3/4">
          <div className="bg-white rounded-xl px-7 py-5">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-gray-400 w-96">You must enter your current password and then type your new password twice.</p>
              <div className="flex flex-col justify-center items-center gap-5 mt-10">
                <div className="flex gap-3 border-b-2 w-1/2 py-2">
                  <FiLock className="text-xl text-gray-400" />
                  <input type="password" placeholder="Current password" className="outline-none" />
                </div>
                <div className="flex gap-3 border-b-2 w-1/2 py-2">
                  <FiLock className="text-xl text-gray-400" />
                  <input type="password" placeholder="New password" className="outline-none" />
                </div>
                <div className="flex gap-3 border-b-2 w-1/2 py-2">
                  <FiLock className="text-xl text-gray-400" />
                  <input type="password" placeholder="Repeat new password" className="outline-none" />
                </div>
                <button className="btn btn-accent text-white capitalize w-1/2 my-10">Change Password</button>
              </div>
            </div>
          </div>
        </section>
